...
<head>
  ...
  <title>Agenda Guru N5 | Dashboard</title>
...
{{-- Bagian Header Ada Dibawah Sini --}}
@include('layout.header')
  <!-- Left sidebar column ada dibawah ini. contains the logo and sidebar -->
